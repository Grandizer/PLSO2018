...
namespace DataContext.Migrations {
	...
	public partial class InitialMigration : Migration {
		...
		protected override void Up(MigrationBuilder migrationBuilder) {
			...
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] {  1,  1, true, "Comments", "*** Comments", "Anything", "Any row with contents in this filed will be ignored", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] {  2,  2, false, "Notes", nameof(Record.Description), "Just behind the McDonald's", "Place any other info here that would aid in searching", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] {  3,  3, false, "Map Image Name", nameof(Record.ImageFileName), "KRAUSE00099", "No spaces, hyphens. 5 digit numerical counter. MUST BE EXACT", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] {  4,  4, false, "Survey Name", nameof(Record.SurveyName), "Lot split for Lustri", "This should be the title as it appears on the map, we shouldn't interpret mistakes here", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] {  5,  5, false, "Client", nameof(Record.ClientName), "Dino A F Lustri", "Full Client name as it appears on the Survey Map. No periods. Include middle initials when applicable", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] {  6,  6, false, "Defunct or Historic Township", nameof(Record.Township), "Dover", "REQUIRED: Full name. No need to include the word township", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] {  7,  7, false, "Lot No.", nameof(Record.OriginalLot), "10,11,12", "REQUIRED: Only Numbers with multiples seperated by commas, no spaces", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] {  8,  8, false, "Section", nameof(Record.Section), "10,11,12", "Only Numbers with multiples seperated by commas, no spaces", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] {  9,  9, false, "Tract", nameof(Record.Tract), "10,11,12,Blake,Ely", "", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 10, 10, false, "County", nameof(Record.County), "Cuyahoga", "REQUIRED: Full county name because first 3 letters are duplated", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 11, 11, true, "Surveyor Name", "*** Surveyor Name", "Frank B Krause Jr", "Full name because there are repate names like Krause", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 12, 12, true, "Surveyor Number", "*** Surveyor Number", "567", "REQUIRED: Only Numbers", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 13, 13, true, "Date Month", "*** Date Month", "OCT", "REQUIRED: 3 letter month", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 14, 14, true, "Date Year", "*** Date Year", "1939", "REQUIRED: Only numbers. 4 digit year", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 15, 15, false, "Address No.", nameof(Record.StreetNumber), "12345A", "This can have letters for unit numbers, etc.", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 16, 16, false, "Principle Street Name", nameof(Record.StreetName), "Southwest New Philly", "Can have spaces, should include full descriptive name", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 17, 17, false, "Street Suffix", nameof(Record.StreetSuffix), "BLVD", "No Periods.  See https://pe.usps.com/text/pub28/28apc_002.htm", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 18, 18, false, "Cross Street Name", nameof(Record.CrossStreet), "NW MAIN ST", "In case of fronting more than one street or corner lots, place second street name here. Entire name can be in this field. If there are more streets like a subdivision plat, those can be listed under the Notes fields.", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 19, 19, false, "City, Village, Township", nameof(Record.City), "Bay Village", "REQUIRED: Spaces are OK", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 20, 20, false, "PPN", nameof(Record.ParcelNumber), "123-45-678,123-45-679", "Numbers and letters depending on county. Separate multiple parcel numbers with commas. Enter entire parcel number, not just ending suffix", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 21, 21, false, "Volume", nameof(Record.DeedVolume), "123", "Numbers Only", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 22, 22, false, "Page", nameof(Record.DeedPage), "45", "Numbers Only", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 23, 23, false, "AFN", nameof(Record.AutomatedFileNumber), "20111965485", "", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 24, 24, false, "Sublot", nameof(Record.Sublot), "10,11,12", "Numbers only. Multiples separated by commas. No spaces", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 25, 25, false, "Subdivision", nameof(Record.Subdivision), "Barrington", "Full subdivision name", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 26, 26, false, "Instrument #/Recorder #/Document #", nameof(Record.RecordingInfo), "???", "???", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 27, 27, false, "Survey Type", nameof(Record.SurveyType), "Boundary", "Enter one of the following or leave blank if unknown: Boundary, Topo, ALTA, MLS", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "IsCalculated", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 28, 28, true, "Location", nameof(Record.Location), "41.498924,-81.689951", "If known, enter the Latitude and Longitude separated by commas", 0 });
		}
