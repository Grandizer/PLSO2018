		...
		protected override void Up(MigrationBuilder migrationBuilder) {
			...
			migrationBuilder.CreateTable(
					...
					columns: table => new {
						...
						SurveyorName = table.Column<string>(unicode: false, maxLength: 50, nullable: false),
			...
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 1, 1, 0, 0, 25, true, false, "Internal Use Only", "*** Parsing Messages", "Do Not Use", "This is the field where parsing messages will go when this file is uploaded.", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 2, 2, 0, 0, 25, true, false, "Comments", "*** Comments", "Anything", "Any row with contents in this field will be IGNORED", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 3, 3, 5, 15, 25, false, true, "Map Image Name", nameof(Record.MapImageName), "KRAUSE00099", "No spaces, hyphens. 5 digit numerical counter. MUST BE EXACT", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 4, 4, 5, 25, 30, false, true, "City, Village, Township", nameof(Record.CityVillageTownship), "Bay Village", "Spaces are OK", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 5, 5, 5, 15, 25, false, true, "County", nameof(Record.County), "Cuyahoga", "Full county name because first 3 letters are duplicated", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 6, 6, 5, 20, 30, false, true, "Defunct or Historic Township", nameof(Record.DefunctTownship), "Dover", "Full name. No need to include the word township", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 7, 7, 0, 15, 25, false, false, "Lot No.", nameof(Record.LotNumbers), "10,11,12", "Only Numbers with multiples seperated by commas, no spaces", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 8, 8, 0, 15, 25, false, false, "Section", nameof(Record.Section), "10,11,12", "Only Numbers with multiples seperated by commas, no spaces", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 9, 9, 0, 15, 25, false, false, "Tract", nameof(Record.Tract), "10,11,12,Blake,Ely", "", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 10, 10, 0, 15, 25, false, false, "Range", nameof(Record.Range), "2N", "Enter if known", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 11, 11, 0, 10, 20, true, true, "Survey Date", nameof(Record.SurveyDate), "10/1/2018", "In the format of MM/DD/YYYY.  If the Day is not know, put a 1", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 12, 12, 5, 25, 25, true, true, "Surveyor Name", "*** Surveyor Name", "Frank B Krause Jr", "Full name because there are repeated names like Krause", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 13, 13, 2, 5, 25, true, false, "Surveyor Number", "*** Surveyor Number", "567", "Only Numbers", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 14, 14, 5, 100, 20, false, true, "Address", nameof(Record.Address), "12345A Southwest New Philly", "This should contain the full street address", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 15, 15, 0, 30, 25, false, false, "Cross Street Name", nameof(Record.CrossStreet), "NW MAIN ST", "In case of fronting more than one street or corner lots, place second street name here. Entire name can be in this field. If there are more streets like a subdivision plat, those can be listed under the Notes fields.", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 16, 16, 0, 30, 25, false, false, "Parcel Numbers", nameof(Record.ParcelNumbers), "123-45-678,123-45-679", "Numbers and letters depending on county. Separate multiple parcel numbers with commas. Enter entire parcel number, not just ending suffix, no spaces", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 17, 17, 1, 8, 20, false, false, "Volume", nameof(Record.DeedVolume), "123", "Numbers Only", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 18, 18, 1, 6, 20, false, false, "Page", nameof(Record.DeedPage), "45", "Numbers Only", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 19, 19, 3, 18, 20, false, false, "AFN/Inst#/Recorder#/Doc#", nameof(Record.AutomatedFileNumber), "20111965485", "Enter the full Recorder/Auditor unique identifier", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 20, 20, 5, 50, 25, false, false, "Subdivision", nameof(Record.Subdivision), "Barrington", "Full subdivision name", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 21, 21, 0, 10, 20, false, false, "Subdivision-Sublot", nameof(Record.Sublot), "10,11,12", "Numbers only. Multiples separated by commas. No spaces", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 22, 22, 0, 50, 25, false, false, "Survey Name", nameof(Record.SurveyName), "Lot split for Lustri", "This should be the title as it appears on the map, we shouldn't interpret mistakes here. Include lables like Boundary, Topo, ALTA, MLS, etc.", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 23, 23, 0, 30, 25, true, false, "Location", nameof(Record.Location), "41.498924,-81.689951", "If known, enter the Latitude and Longitude separated by commas", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 24, 24, 0, 50, 25, false, false, "Client", nameof(Record.ClientName), "Dino A F Lustri", "Full Client name as it appears on the Survey Map. No periods. Include middle initials when applicable", 0 });
			migrationBuilder.InsertData(schema: "ref", table: nameof(ExcelTemplate), columns: new[] { "ID", "ColumnIndex", "MinimumLength", "MaximumLength", "ColumnWidth", "IsCalculated", "IsRequired", "DisplayName", "FieldName", "ExampleData", "Validation", "ModifiedByID" }, values: new object[] { 25, 25, 0, 2000, 25, false, false, "Notes", nameof(Record.Notes), "Just behind the McDonald's", "Place any other info here that would aid in searching", 0 });
